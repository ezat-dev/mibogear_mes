  ...
  <div class="cutumModal">    
    <div class="detail">
      ...
      <table class="formTable">
        <tr>
          <th>거래처명</th>
          <td><input type="text" id="corp_name" name="corp_name" class="inputField">
          <input id="corp_code" name="corp_code"  type="hidden" readonly="readonly"></td>
          
          <th>사업자번호</th>
          <td><input type="text" id="corp_no" name="corp_no" class="inputField"></td>
        </tr>
        <tr>
          <th>전화번호</th>
          <td><input type="text" id="corp_tel" name="corp_tel" class="inputField"></td>
          <th>팩스번호</th>
          <td><input type="text" id="corp_fax" name="corp_fax" class="inputField"></td>
        </tr>
        <tr>
          <th>대표자</th>
          <td><input type="text" id="corp_boss" name="corp_boss" class="inputField"></td>
          <th>담당자</th>
          <td><input type="text" id="corp_mast" name="corp_mast" class="inputField"></td>
        </tr>
        <tr>
          <th>담당자 휴대폰</th>
          <td><input type="text" id="corp_hp" name="corp_hp" class="inputField"></td>
          <th>업태</th>
          <td><input type="text" id="corp_upte" name="corp_upte" class="inputField"></td>
        </tr>
        <tr>
          <th>업종</th>
          <td><input type="text" id="corp_upjo" name="corp_upjo" class="inputField"></td>
          <th>주소</th>
          <td colspan="3"><input type="text" id="corp_add" name="corp_add" class="inputField" style="width:95%;"></td>
        </tr>
      </table>
...
function cutumInsertDetail(corp_code){
	$.ajax({
		url:"/mibogear/standardManagement/cutumInsert/cutumInsertDetail",
		type:"post",
		dataType:"json",
		data:{
			"corp_code":corp_code
...
function save() {
    ...
    $.ajax({
        url: "/mibogear/standardManagement/cutumInsert/cutumInsertSave",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function deleteCutum() {
    ...
    $.ajax({
        url: "/mibogear/standardManagement/cutumInsert/cutumDelete",
        type: "POST",
        data: {
